...
class RolesModel extends Model
{
	...
	{
		return $this->belongsToMany(Propertys::class,"roles_propertys","object_id","property_id")->withPivot("value","params");
	}
	...
	{
		return DB::table("roles_fields")->get();
	}
}