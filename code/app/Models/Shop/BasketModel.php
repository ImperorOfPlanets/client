...
{
	protected $table = "basket_objects";
	...
	{
		return $this->belongsToMany(Propertys::class,"basket_propertys","object_id","property_id")->withPivot("value","params");
	}
	...
	{
		return DB::table("basket_fields")->get();
	}
}