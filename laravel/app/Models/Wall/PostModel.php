...
class PostModel extends Model
{
	...
	{
		return $this->belongsToMany(Propertys::class,"post_propertys","object_id","property_id")->withPivot("value","params");
	}
	...
	{
		return DB::table("post_fields")->get();
	}
}