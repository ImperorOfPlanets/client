...
{
	protected $table = "section_objects";
	...
	{
		return $this->belongsToMany(Propertys::class,"section_propertys","object_id","property_id")->withPivot("value","params");
	}
	...
	{
		return DB::table("section_fields")->get();
	}
}