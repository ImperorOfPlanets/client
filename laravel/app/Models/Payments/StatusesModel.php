...
{
	protected $table = "payment_statuses_objects";
	...
	{
		return $this->belongsToMany(Propertys::class,"payment_statuses_propertys","object_id","property_id")->withPivot("value","params");
	}
	...
	{
		return DB::table("payment_statuses_fields")->get();
	}
}