...
class sendFiles implements ShouldQueue
{
	...
	public function run($obj)
	{
		...
		$this->ssh->sendFile($this->params['myPath'],$this->params['remotePath']);
		...
		if(is_array($this->params['myPath']))
		{
			...
			{
				$this->ssh->sendFile($this->params['myPath'][$key],$this->params['remotePath'][$key]);
			}
		}
		else
		{
